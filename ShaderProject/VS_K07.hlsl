...
VS_OUT main(VS_IN vin)
{
    ...
    // 光源からの
    vout.screenPos = mul(vout.screenPos, lightWorld); // ワールド座標
    vout.screenPos = mul(vout.screenPos, lightView); // ビュー座標
    vout.screenPos = mul(vout.screenPos, lightProj); // プロジェクション座標
